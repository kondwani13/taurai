...
<body>
    ...
    <div id="content-wrapper">
        ...
        <div class="faq-page-section section section-margin mb-0">
            <div class="container">
                <h3 class="text-center ff-rubik fw-500 mb-xl-16 mb-lg-12 mb-md-10 mb-8">How Frequently asked questions.</h3>
                <div class="faq-accordion accordion mx-auto" id="faq-example">
                    <div class="card active">
                        <div class="card-header">
                            <button data-toggle="collapse" data-target="#faqOne">How do you order a Dean Rode piece?</button>
                        </div>

                        <div id="faqOne" class="collapse show" data-parent="#faq-example">
                            <div class="card-body">
                                <p>At DEAN RODE, we specialize in made-to-order garments tailored to fit our clients perfectly. To place an order, please contact us at design@deanrode.com and provide your measurements.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <button class="collapsed" data-toggle="collapse" data-target="#faqTwo">How do you get styled by TAURAI or DEAN RODE?</button>
                        </div>
                        <div id="faqTwo" class="collapse" data-parent="#faq-example">
                            <div class="card-body">
                                <p>For styling services by TAURAI or DEAN RODE, please reach out to us via email at marketing@deanrode.com or send us a direct message on our Instagram profile @deanrode_.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <button class="collapsed" data-toggle="collapse" data-target="#faqThree">Do you accept commissions for artwork?</button>
                        </div>
                        <div id="faqThree" class="collapse" data-parent="#faq-example">
                            <div class="card-body">
                                <p>For art inquiries, please contact info@taurai.com or send a direct message via Instagram to @7aurai.</p>
                            </div>
                        </div>
                    </div>

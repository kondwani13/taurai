...
<body>
    ...
    <div class="page-header-section shop-page section">
        <div class="container">
        ...
        <div class="gallery-page-section section section-margin mb-0">
            <div class="container">
                <div class="gallery-grid-filter center">
                    <button data-filter="*" class="active">Discography</button>
                ...
                <div class="gallery-grid row row-cols-lg-3 row-cols-md-2 row-cols-1 mb-n6">
                    ...
                    <div class="fashion grid-item col mb-6">
                        <a href="https://www.youtube.com/watch?v=IiPmAcw8JhU" class="mfp-video gallery5 video">
                            <img src="assets/images/music/mu1.png" alt="Gallery Image">
                            <span class="icon"><img class="svg-inject" src="assets/images/icons/chevron-right.svg" alt="Gallery Zoom Icon"></span>
                            
                            <h3 class="title">Accountability new</h3>
                        </a>
                    </div>
                    <div class="fashion grid-item col mb-6">
                        <a href="https://www.youtube.com/watch?v=piIJahVDGCQ" class="mfp-video gallery5 video">
                            <img src="assets/images/music/mu2.png" alt="Gallery Image">
                            <span class="icon"><img class="svg-inject" src="assets/images/icons/chevron-right.svg" alt="Gallery Zoom Icon"></span>
                            
                            <h3 class="title">Be mine 2022</h3>
                        </a>
                    </div>
                    <div class="fashion grid-item col mb-6">
                        <a href="https://www.youtube.com/watch?v=7dhY8CgX5Yk" class="mfp-video gallery5 video">
                            <img src="assets/images/music/mu3.png" alt="Gallery Image">
                            <span class="icon"><img class="svg-inject" src="assets/images/icons/chevron-right.svg" alt="Gallery Zoom Icon"></span>
                            
                            <h3 class="title">Falling for you-plain</h3>
                        </a>
                    </div>
                    <div class="fashion grid-item col mb-6">
                        <a href="https://www.youtube.com/watch?v=-vjHycezsJQ" class="mfp-video gallery5 video">
                            <img src="assets/images/music/mu4.png" alt="Gallery Image">
                            <span class="icon"><img class="svg-inject" src="assets/images/icons/chevron-right.svg" alt="Gallery Zoom Icon"></span>
                            
                            <h3 class="title">Free Falling (Official Audio)</h3>
                        </a>
                    </div>
                    <div class="fashion grid-item col mb-6">
                        <a href="https://www.youtube.com/watch?v=GjXo5jcYSIc" class="mfp-video gallery5 video">
                            <img src="assets/images/music/mu5.png" alt="Gallery Image">
                            <span class="icon"><img class="svg-inject" src="assets/images/icons/chevron-right.svg" alt="Gallery Zoom Icon"></span>
                            
                            <h3 class="title">Demonstraight (Official Audio)</h3>
                        </a>
                    </div>
